...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasToken =
        StorageService.token != null && StorageService.token!.isNotEmpty;
    ...
    log('App initialization - hasToken: $hasToken, isActive: ${StorageService.userData?['isActive']}, initialRoute: $initialRoute',
        name: 'APP_INIT');
