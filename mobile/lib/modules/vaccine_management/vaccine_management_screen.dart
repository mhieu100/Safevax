            ...
            Expanded(
              child: TabBarView(
                children: [
                  ...
                  _VaccinationRecordsTab(), // Vaccination history content
                ],
              ),
            ),
          ],
...
class _BookingHeader extends StatelessWidget {
  ...
  const _BookingHeader(
      {required this.booking, this.onBookingTap, this.onCancel});
...
class _StatusBadge extends StatelessWidget {
  ...
  (Color, String) _getStatusInfo(String status) {
    return switch (status) {
      ...
      'ongoing' => (ColorConstants.secondaryGreen, 'Đang tiến hành'),
