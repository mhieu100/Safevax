...
VALUES (
    ...
    (
        ...
        '2025-12-19 00:00:00.000000',
        false
    );-- Add new columns if they don't exist (assuming JPA might update schema, but data needs values)
-- This block is just values update for the existing rows based on slug
