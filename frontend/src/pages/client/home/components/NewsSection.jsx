      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {loading
            ...
            : news.map((item, index) => (
                <FadeIn key={item.id} delay={index * 100} direction="up" className="h-full">
                  <button
                    type="button"
                    className="group flex flex-col bg-white rounded-3xl border border-slate-100 overflow-hidden hover:shadow-2xl hover:shadow-blue-900/5 transition-all duration-500 hover:-translate-y-2 cursor-pointer text-left w-full h-full"
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-grow p-6 w-full">
                      ...
                      <div className="flex items-center text-blue-600 text-sm font-semibold group-hover:translate-x-2 transition-transform duration-300">
                        {t('client:home.news.readArticle')}{' '}
